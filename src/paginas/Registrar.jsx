...
const Registrar = () => {
    ...
    const handleSubmit = async e => {
        ...
        if(password.length < 6){
            setAlerta ({
                msg:'Los password es muy corto agrega mínimo 6',
                error:true
            })
        return
        }
        ...
        try {
            // TODO_ Mover hacia un cliente Axios
  ...
  return (
    <>
            <h1 className="text-sky-600 font-black text-6xl capitalize">Crea tu cuenta y adeministra tus
            ...
            >
                ...
                <div className="my-5">
                    ...
                    <input
                        id="repPassword"
                        type="password"
                        placeholder="Repetición Password"
                        className="w-full mt-3 p-3 border rounder-xl bg-gray-50"
            ...
            <nav className="lg:flex lg:justify-between ">
                ...
                to="/registrar"
            > No tienes una cuenta? Registraste</Link>
              <Link
                className='block text-center my-5 text-slate-500 uppercase text-sm'
                to="/olvide-password"
